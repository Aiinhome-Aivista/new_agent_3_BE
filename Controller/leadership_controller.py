...
from services.leadership_service import get_manager_wise_summary, get_manager_wise_risk_summary, get_knowledge_giver_ranking, get_manager_wise_tracking_summary
...
@leadership_bp.route('/tracking-summary', methods=['GET'])
def get_tracking_summary():
    try:
        summary = get_manager_wise_tracking_summary()
        return jsonify({"success": True, "data": summary}), 200
    except Exception as e:
        return jsonify({"success": False, "message": str(e)}), 500
